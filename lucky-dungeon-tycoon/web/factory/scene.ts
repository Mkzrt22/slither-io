...
export class FactoryScene {
  ...
  private viewSize = 19; private targetViewSize = 19; private aspect = 1;
  ...
  private buildProps(): void {
    ...
    for (const [x, z] of [[-11.5, 7.5], [11.5, 7.5], [-11.5, -7], [11.5, -7]] as Array<[number, number]>) {
